...
if("TRUE" STREQUAL "TRUE")
  set(fssim_description_SOURCE_PREFIX /home/andva/PromRacing/fsd_skeleton/src/fssim/fssim_description)
  set(fssim_description_DEVEL_PREFIX /home/andva/PromRacing/fsd_skeleton/devel/.private/fssim_description)
  ...
  set(fssim_description_INSTALL_PREFIX /home/andva/PromRacing/fsd_skeleton/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fssim_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/andva/PromRacing/fsd_skeleton/src/fssim/fssim_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT fssim_description_NUM_DUMMY_TARGETS)
      set(fssim_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::fssim_description::wrapped-linker-option${fssim_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR fssim_description_NUM_DUMMY_TARGETS "${fssim_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::fssim_description::wrapped-linker-option${fssim_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND fssim_description_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/andva/PromRacing/fsd_skeleton/devel/.private/fssim_description/lib;/home/andva/PromRacing/fsd_skeleton/devel/lib;/home/andva/PromRacing/simulator/ws/devel/lib;/home/andva/Sxolh/robo2/robo2_redundant/workspace/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(fssim_description_EXPORTED_TARGETS ${${fssim_description_dep}_EXPORTED_TARGETS})
endforeach()
