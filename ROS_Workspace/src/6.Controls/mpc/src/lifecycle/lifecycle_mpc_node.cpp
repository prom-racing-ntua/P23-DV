...
namespace mpc {
    ...
    void LifecycleMpcHandler::setSubscribers() {
        velocity_subscriber_ = this->create_subscription<custom_msgs::msg::VelEstimation>("velocity_estimation", 10, std::bind(&LifecycleMpcHandler::velocity_callback, this, std::placeholders::_1));
    ...
    void LifecycleMpcHandler::velocity_callback(const custom_msgs::msg::VelEstimation::SharedPtr vel_msg) {
    ...
    void LifecycleMpcHandler::mpc_callback() {
