...
classdef FORCESNLPsolverBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function [output, exitflag, info] = forcesInitOutputsMatlab()
            ...
            outputs_x26 = coder.nullcopy(zeros(10, 1));
            outputs_x27 = coder.nullcopy(zeros(10, 1));
            outputs_x28 = coder.nullcopy(zeros(10, 1));
            outputs_x29 = coder.nullcopy(zeros(10, 1));
            outputs_x30 = coder.nullcopy(zeros(10, 1));
    ...
    methods (Static, Access = private)
        function [output, exitflag, info] = forcesInitOutputsC()
            ...
            outputs_x26 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x27 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x28 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x29 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x30 = coder.nullcopy(double(zeros(10, 1)));
            output = struct('x01', outputs_x01,...
                            'x02', outputs_x02,...
                            'x03', outputs_x03,...
                            'x04', outputs_x04,...
