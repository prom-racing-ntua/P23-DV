...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	for(i = 0; i < 10; i++)
	{
		outputs[250 + i] = (real_T) output.x26[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[260 + i] = (real_T) output.x27[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[270 + i] = (real_T) output.x28[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[280 + i] = (real_T) output.x29[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[290 + i] = (real_T) output.x30[i];
	}
