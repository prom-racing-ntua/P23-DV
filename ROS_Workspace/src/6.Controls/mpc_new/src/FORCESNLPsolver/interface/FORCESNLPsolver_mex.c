...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
	...
	/* column vector of length 10 */
	outvar = mxCreateDoubleMatrix(10, 1, mxREAL);
	copyCArrayToM_double((&(output.x26[0])), mxGetPr(outvar), 10);
	mxSetField(plhs[0], 0, "x26", outvar);


	/* column vector of length 10 */
	outvar = mxCreateDoubleMatrix(10, 1, mxREAL);
	copyCArrayToM_double((&(output.x27[0])), mxGetPr(outvar), 10);
	mxSetField(plhs[0], 0, "x27", outvar);


	/* column vector of length 10 */
	outvar = mxCreateDoubleMatrix(10, 1, mxREAL);
	copyCArrayToM_double((&(output.x28[0])), mxGetPr(outvar), 10);
	mxSetField(plhs[0], 0, "x28", outvar);


	/* column vector of length 10 */
	outvar = mxCreateDoubleMatrix(10, 1, mxREAL);
	copyCArrayToM_double((&(output.x29[0])), mxGetPr(outvar), 10);
	mxSetField(plhs[0], 0, "x29", outvar);


	/* column vector of length 10 */
	outvar = mxCreateDoubleMatrix(10, 1, mxREAL);
	copyCArrayToM_double((&(output.x30[0])), mxGetPr(outvar), 10);
