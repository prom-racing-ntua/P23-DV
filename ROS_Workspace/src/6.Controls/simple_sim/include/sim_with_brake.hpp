...
struct Constants
{
    double m, Iz, wheelbase, c_tire, P_air, CdA, ClA, gr, eff, R_wheel, g, h_cog, wd, R_disk_f, R_disk_r, mi_disk, d_piston;
    int N_front, N_rear;
    Constants() {}
    Constants(double _1, double _2, double _3, double _4, double _5, double _6, double _7, double _8, double _9, double _10, double _11, double _12, double _13, int _14, int _15, double _16, double _17, double _18, double _19):
    m(_1), Iz(_2), wheelbase(_3), c_tire(_4), P_air(_5), CdA(_6), ClA(_7), gr(_8), eff(_9), R_wheel(_10), g(_11), h_cog(_12), wd(_13), N_front(_14), N_rear(_15),  R_disk_f(_16), R_disk_r(_17), mi_disk(_18), d_piston(_19) {}
};
