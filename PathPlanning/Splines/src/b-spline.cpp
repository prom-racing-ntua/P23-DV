...
int main() {
    ...
    // path_planning::PointsArray points{8, 2};
    // points <<
    //     0, 0,
    //     3, 1,
    //     8, 6,
    ...
    path_planning::BSpline spline{midpoints, path_planning::BoundaryCondition::ClosedLoop};
    ...
    std::ofstream spline_curve("b_spline_points.txt");
